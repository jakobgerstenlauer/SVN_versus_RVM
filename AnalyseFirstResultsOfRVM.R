...
#
# This script represents the first analysis made to the result of RVM.
...
# "Results_Simulation_RVM_KMLMM_term_project_DATEXXXXX.csv"
# The output data files
# A csv document named "RVM_results_table_KMLMM_term_project_DATEXXXXX.csv"
# A latex formated table from the results table named "result_table_rvm.tex"
#
# Date: 22.12.2016
# Jakob Gerstenlauer
