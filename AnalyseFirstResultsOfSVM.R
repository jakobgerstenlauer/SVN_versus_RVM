...
str(d)
#there was a mistake in the first run: num.observations and num.vars were mixed up!
...
#The imperfect model only occurred with data generated by polynomial degree 3!
